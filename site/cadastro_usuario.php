...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/cadastro_usuario.js"></script>
        
        <link rel="stylesheet" href="recursos/css/jquery.dataTables.min.css">
        <script src="recursos/js/jquery.dataTables.min.js"></script>
        <script>
            $(document).ready(function () {
                $('#formulario').load('recursos/includes/formulario/formulario_usuario.php');
                $('#listar').load('recursos/includes/listar/listar_usuario.php');
